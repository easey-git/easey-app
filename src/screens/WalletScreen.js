...
const WalletScreen = ({ navigation }) => {
    ...
    const itemStats = useMemo(() => {
        ...
        // High Volume Fetcher for Charts (Limit 1000)
        useEffect(() => {
            const fetchChartData = async () => {
                ...
                // Fetch up to 1000 items for analytics
                const q = query(collection(db, "wallet_transactions"), ...queryConstraints, limit(1000));
