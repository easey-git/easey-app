...
const AdminPanelScreen = ({ navigation }) => {
    ...
    const ROLE_PRESETS = {
        'Manager': ['view_financial_stats', 'view_order_stats', 'access_orders', 'access_wallet', 'access_campaigns', 'access_whatsapp', 'access_analytics', 'payu_access', 'manage_orders', 'manage_wallet', 'manage_campaigns', 'manage_users'],
